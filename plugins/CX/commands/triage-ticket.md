...
```
/triage-ticket <ticket text, customer message, or issue description>
```

Examples:
- `/triage-ticket Customer says their dashboard has been showing a blank page since this morning`
- `/triage-ticket "I was charged twice for my subscription this month"`
- `/triage-ticket User can't connect their SSO — getting a 403 error on the callback URL`
- `/triage-ticket Feature request: they want to export reports as PDF`
