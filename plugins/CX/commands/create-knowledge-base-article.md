---
description: Create a knowledge base article from a resolved issue or common question
...
```
/create-knowledge-base-article <resolved issue, ticket reference, or topic description>
```

Examples:
- `/create-knowledge-base-article How to configure SSO with Okta — resolved this for 3 customers last month`
- `/create-knowledge-base-article Ticket #4521 — customer couldn't export data over 10k rows`
- `/create-knowledge-base-article Common question: how to set up webhook notifications`
- `/create-knowledge-base-article Known issue: dashboard charts not loading on Safari 16`
