...
description: Analyze competitor UX/UI with flow comparison, pattern analysis, and design implications. Use when researching competitor design, comparing flows or patterns, or preparing a competitive design brief.
---
