...
description: Synthesize UX research from usability tests, user testing, and feedback into structured insights and design recommendations. Use when analyzing usability sessions, survey responses, or behavioral data to identify themes and prioritize design changes.
---
