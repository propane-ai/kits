---
name: call-prep
description: Prepare for a GTM/sales call with account context, attendee research, and suggested agenda. Works standalone with user input and web research, supercharged when you connect your ~~CRM~~, ~~email~~, ~~chat~~, or ~~conversation intelligence~~. Trigger with "prep me for my call with [company]", "I'm meeting with [company] prep me", "call prep [company]", or "get me ready for [meeting]".
---
...
Get fully prepared for any GTM or sales call in minutes. This skill works with whatever context you provide, and gets significantly better when you connect your GTM tools.
...
│  + ~~conversation intelligence~~: prior call recordings, key moments              │
...
5. ~~conversation intelligence~~ → Find prior calls
