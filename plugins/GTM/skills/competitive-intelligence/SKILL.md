...
│  ✓ GTM talk tracks: how to position against each competitor   │
...
│  + ~~knowledge base~~: Existing battlecards, competitive playbooks            │
│  + ~~chat~~: Internal intel, field reports from colleagues          │
│  + ~~conversation intelligence~~: Competitor mentions in customer calls           │
└─────────────────────────────────────────────────────────────────┘
```
...
- **Data Sources**: Web research [+ ~~CRM~~] [+ ~~knowledge base~~] [+ ~~conversation intelligence~~]
