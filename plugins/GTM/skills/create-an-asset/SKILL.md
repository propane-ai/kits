...
description: Generate tailored GTM assets (landing pages, decks, one-pagers, workflow demos) from your deal context. Describe your prospect, audience, and goal — get a polished, branded asset ready to share with customers.
---
...
**Persist to ~~knowledge base~~** for future sessions (when connected). On subsequent invocations, confirm: "I have your seller context from last time — still selling [Product] at [Company]?"
...
*Skill created for generalized GTM asset generation. Works for any seller, any product, any prospect.*
