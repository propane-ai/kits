...
description: Research a company or person and get actionable GTM intel. Works standalone with web search, supercharged when you connect ~~data enrichment~~ or ~~CRM~~. Trigger with "research [company]", "look up [person]", "intel on [prospect]", "who is [name] at [company]", or "tell me about [company]".
---
...
Get a complete picture of any company or person before outreach. This skill always works with web search, and gets significantly better with ~~data enrichment~~ and ~~CRM~~ data.
...
│  + ~~data enrichment~~: verified emails, phone, tech stack, org chart    │
...
I'll run web searches immediately. If you have ~~data enrichment~~ or ~~CRM~~ connected, I'll pull that data too.
...
|-----------|--------------|
| **~~data enrichment~~** | Verified emails, phone numbers, tech stack, org chart, funding details |
...
**Generated:** [Date]
**Sources:** Web Search [+ ~~data enrichment~~] [+ ~~CRM~~]
...
| **~~email~~** | [If ~~data enrichment~~ connected] |
...
## Tech Stack [If ~~data enrichment~~ Connected]
...
### Step 3: ~~data enrichment~~ (If Connected)
