...
Process call notes or a transcript to extract action items, draft follow-up communications, and update records. Uses the **summarize-call** skill.
...
│  + ~~conversation intelligence~~: Pull recording automatically (e.g. Gong, Fireflies) │
...
**~~conversation intelligence~~ connected (e.g. Gong, Fireflies):**
