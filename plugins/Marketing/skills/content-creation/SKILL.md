...
Pull brand voice and style from **~~knowledge base~~** (style guide, messaging pillars, past examples); reference **~~design~~** for brand assets and templates when creating landing pages or social. See [REFERENCE.md](../../REFERENCE.md). If not connected, use local settings or user-provided guidelines and note "Connect ~~knowledge base~~ for consistent brand voice across content."
