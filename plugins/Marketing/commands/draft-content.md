...
- **~~knowledge base** (if connected):** Style guide, brand voice, messaging pillars, past examples. See [REFERENCE.md](../REFERENCE.md).
- **~~design** (if connected):** Brand assets, templates, visual references for landing pages or social.
- **~~marketing automation** (if connected):** Past campaign or content performance to inform angle or format.
- If no tool is connected, use local settings or user-provided guidelines; note "Connect ~~knowledge base~~ for consistent brand voice across content."
