...
User runs `/draft-competitive-brief` or asks for a competitive analysis, competitor research, or market comparison.
...
- **~~SEO** (if connected):** Competitor traffic, keyword rankings, content gaps. See [REFERENCE.md](../REFERENCE.md).
- **~~knowledge base** (if connected):** Existing battlecards, positioning docs, past competitive briefs.
- **~~product analytics** (if connected):** Your own traffic and conversion context to compare with competitor themes.
- If no tools are connected, use web search for research and note "Connect ~~SEO~~ or ~~knowledge base~~ for richer competitive data."
