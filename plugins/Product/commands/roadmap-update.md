...
If **~~chat~~** or **~~meeting transcription~~** is connected:
- Pull recent decisions or blockers that affect the roadmap
...
- "Want me to draft the roadmap change for ~~chat~~ or ~~knowledge base~~?"
